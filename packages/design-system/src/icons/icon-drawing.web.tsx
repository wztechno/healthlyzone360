...
const GRID_24_DRAWINGS: Partial<Record<IconName, ReactElement>> = {
    ...
    /*
     * The workspace's own marks: the destination tiles on `/workspace` (`AREA_ICONS`) and the
     * workspace pages every non-kitchen area lists (`WORKSPACE_NAVIGATION`). They were typed glyphs
     * — `◈`, `◇`, `◊` — which read as three sizes of one diamond on the rail.
     */
    store: (
        <>
