...
export function KdsTicketsScreen() {
    return (
        <Stack space="md" className="flex-1 p-4" testID="kds-tickets">
            <Heading level={1}>Kitchen display</Heading>
            <Text tone="secondary">
                Live tickets from orders and production batches. Requires network connectivity.
            </Text>
            <Card padding="md">
                <Text tone="secondary" testID="kds-tickets-empty">
                    No tickets in queue.
                </Text>
            </Card>
        </Stack>
