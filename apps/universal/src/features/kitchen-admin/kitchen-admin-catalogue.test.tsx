...
describe('editing a meal', () => {
    ...
    it('writes a day of availability by its calendar date, and reads it back', async () => {
        ...
        await untilVisible('kitchen-meal-editor-screen-steps-serviceDays');
        await act(async () => {
            fireEvent.press(screen.getByTestId('kitchen-meal-editor-screen-steps-serviceDays'));
        });
...
describe('creating a meal', () => {
    ...
    it('sends the form it holds, and lands on the record the server answered with', async () => {
        ...
        // Meal types are the second step; the draft typed on the first survives the move.
        await act(async () => {
            fireEvent.press(screen.getByTestId('kitchen-meal-editor-screen-steps-when'));
        });
        await untilVisible('kitchen-meal-type-lunch');
        await act(async () => {
         ...
         * typed before the first save is not lost. The step opens on its empty state.
         *
        ...
        await untilVisible('kitchen-meal-availability-empty');
