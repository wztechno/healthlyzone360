...
class UpdateCatalogueItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kitchen_category' => ['sometimes', 'nullable', 'string', 'max:120'],
            'kitchen_subcategory' => ['sometimes', 'nullable', 'string', 'max:120'],
            ...
            */
            'sells_from_finished_stock' => ['sometimes', 'boolean'],
            'net_content_quantity' => ['sometimes', 'nullable', 'numeric', 'min:0.0001'],
            'net_content_unit_id' => ['sometimes', 'nullable', 'uuid'],
