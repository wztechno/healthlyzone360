...
/**
 * The private GreenLife importer (master plan v2 §4.11, mechanism (c)).
 *
 ...
 */
final readonly class GreenLifeImport
{
    ...
    {
        $this->audit->record(
            'catalogue.greenlife_import_started',
    ...
    public function auditFinish(ImportOptions $options, ImportReport $report): void
    {
        ...
        $this->audit->record(
            'catalogue.greenlife_import_finished',
            actorUserId: $this->context->userId(),
            subjectType: 'organisation',
            subjectId: $options->organisationSlug,
            purposeOfUse: PurposeOfUse::OrganisationAdministration->value,
    ...
    {
        return (string) config('kitchens.import.source_system', 'greenlife_phase1');
    }
}
