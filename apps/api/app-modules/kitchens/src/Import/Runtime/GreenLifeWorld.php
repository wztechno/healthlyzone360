...
/**
 * The shell a GreenLife import needs before it can write anything: one
 ...
 * create here.
 *
 * **The three tariffs land as drafts.** `greenlife-b2c-usd` and
 * `greenlife-b2b-usd` receive the product list's real numbers as `confirmed`
 * rows, and `greenlife-plans-usd` receives one NULL-amount `placeholder` row
 ...
 * has to remember.
 */
final readonly class GreenLifeWorld
{
    public const string ORGANISATION_NAME = 'Green Life Kitchen';
    ...
    public const string PRICE_LIST_B2C = 'greenlife-b2c-usd';

    public const string PRICE_LIST_B2B = 'greenlife-b2b-usd';

    public const string PRICE_LIST_PLANS = 'greenlife-plans-usd';

    public const string CATALOGUE = 'greenlife-main';
    ...
    private function catalogue(Organisation $organisation, ImportReport $report): Catalogue
    {
        ...
        $catalogue->name_en = 'Green Life Kitchen catalogue';
        $catalogue->name_ar = 'كتالوج مطبخ غرين لايف';
