 ...
 * `ApplicationService::write()` runs a conditional `UPDATE ... WHERE
 ...
 * edge rather than remove duplication — the same rule the catalogues module
 * states about its own copy. The `StaleLockVersion` exception, a *type* that
 * three modules must agree on, is the thing that did earn a home in `Support`.
 */
