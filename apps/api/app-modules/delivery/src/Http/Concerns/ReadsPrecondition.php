...
namespace Healthy360\Delivery\Http\Concerns;
...
/**
 * The `If-Match` half of the optimistic-concurrency contract, as the delivery
 * controllers see it.
 *
 ...
 *
 * A fourth copy of eight lines, and deliberately so — the argument the
